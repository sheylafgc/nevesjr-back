...
class HomePageAPIView(APIView):
    ...
    def get(self, request):
        ...
        data = {
            ...
            'section5_feedbacks': serializer.data['section5_feedbacks'],
            'section6_title': getattr(home_page, f'section6_title_{lang}', ''),
            'section6_subtitle': getattr(home_page, f'section6_subtitle_{lang}', ''),
            'section6_vehicles': serializer.data['section6_vehicles'],
            'section7_title': getattr(home_page, f'section7_title_{lang}', ''),
            'section7_frequently_questions': serializer.data['section7_frequently_questions'],
