...
urlpatterns = [
    ...
    path('booking/cancel/<int:booking_id>/', BookingCancelUserAPIView.as_view(), name='booking-cancel'),
    ...
    path('booking/cancel/admin/<int:booking_id>/', BookingCancelAdminAPIView.as_view(), name='booking-admin-cancel'),
